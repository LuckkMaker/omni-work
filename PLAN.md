...
DAPLink Work 是一套基于 DAPLink 仿真下载器的桌面端嵌入式开发工具集，目标是提供类似 SEGGER J-Link 工具链的完整体验，但以开源的 DAPLink 硬件为基础，降低嵌入式开发者的工具成本。

### 1.2 对标产品映射

| J-Link 工具 | DAPLink Work 对应模块 | 核心功能 |
|---|---|---|
...
```
┌─────────────────────────────────────────────────────────────┐
│  DAPLink Work          [Flash] [Commander] [RTT] [Scope]    │  ← 顶部导航栏
├─────────────────────────────────────────────────────────────┤
│                                                             │
│  ┌─ 探针选择 ──────────┐  ┌─ 目标信息 ───────────────────┐  │
